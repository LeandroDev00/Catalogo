    ...
    productCard.innerHTML = `
        ...
        <div class="mt-5">
            ...
            <div>
                ...
                <button class="bg-gray-900 px-5 rounded w-28 hover:scale-110 duration-300 hover:bg-gray-500 add-to-cart-btn" data-name="${product.title}" data-price="${product.dataprice}" data-code="${product.code}" data-image="${product.imgScr}">
